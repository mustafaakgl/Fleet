  ...
  'B-TK 710': [
    {
      ...
      position: 'Pablo-Neruda-Straße 22, Berlin',
    ...
    },
    {
      ...
      fuel: '88%',
      chargeStatus: 'Keine Daten',
      position: 'Nobelstraße 25, Berlin',
      distance: '10,3 km',
    ...
    },
    {
      ...
      fuel: '82%',
      chargeStatus: 'Keine Daten',
      position: 'Nobelstraße 20, Berlin',
      distance: '0,0 km',
      duration: '2 h 27 min',
    },
    {
      ...
      fuel: '83%',
      chargeStatus: 'Keine Daten',
      position: 'Rudolf-Rühl-Allee, Berlin',
      distance: '9,0 km',
      duration: '23 min 2 s',
    },
  ],
  ...
  return (
    <aside className="flex w-full shrink-0 flex-col border-r border-slate-200 bg-white xl:w-[320px]">
      ...
      <div className="flex items-center justify-between border-b border-slate-200 bg-slate-50 px-5 py-3 text-xs font-semibold uppercase tracking-wide text-slate-500">
        ...
        <span className="rounded-full bg-white px-2 py-0.5 text-cyan-700 shadow-sm">{vehicles.length}</span>
      </div>
    ...
    <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="grid gap-4 xl:grid-cols-[1.2fr_1fr]">
        <div>
          ...
          <h3 className="mt-2 text-2xl font-bold text-slate-900">{vehicle}</h3>
          <p className="mt-1 text-sm text-slate-600">VIN: {summary.vin}</p>
          <div className="mt-4 rounded-lg bg-cyan-50 px-4 py-3 text-sm font-semibold text-cyan-800">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-lg border border-slate-200 p-3">
            ...
            <p className="mt-1 text-sm text-slate-600">{summary.startAddress}</p>
          </div>
          <div className="rounded-lg border border-slate-200 p-3">
            <p className="text-xs uppercase tracking-wide text-slate-500">Ende</p>
            <p className="mt-1 text-sm font-semibold text-slate-900">{summary.endTime}</p>
            <p className="mt-1 text-sm text-slate-600">{summary.endAddress}</p>
          </div>
          <div className="rounded-lg border border-slate-200 p-3">
          ...
          <div className="rounded-lg border border-slate-200 p-3">
            <p className="text-xs uppercase tracking-wide text-slate-500">Found events</p>
          ...
          <tbody>
            {events.map((event, index) => (
              <tr key={`${event.timestamp}-${index}`} className="border-t border-slate-100 hover:bg-slate-50">
                <td className="px-3 py-2.5 font-medium text-slate-900">{event.eventDetails}</td>
                <td className="px-3 py-2.5 text-slate-700">{event.timestamp}</td>
                <td className="px-3 py-2.5 text-slate-700">{event.driver}</td>
                <td className="px-3 py-2.5 text-slate-700">{event.odometer}</td>
                <td className="px-3 py-2.5 text-slate-700">{event.speed}</td>
                <td className="px-3 py-2.5 text-slate-700">{event.fuel}</td>
                <td className="px-3 py-2.5 text-slate-700">{event.chargeStatus}</td>
                <td className="px-3 py-2.5 text-slate-700">{event.position}</td>
                <td className="px-3 py-2.5 text-slate-700">{event.distance}</td>
                <td className="px-3 py-2.5 text-slate-700">{event.duration}</td>
              </tr>
            ))}
          </tbody>
        </table>
    ...
    <div className="space-y-4">
      <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
            <input defaultValue="19.05.2026 00:00" className="h-10 rounded-md border border-slate-300 bg-white px-3 text-sm text-slate-900 focus:border-cyan-600 focus:outline-none" />
            <input defaultValue="19.05.2026 09:57" className="h-10 rounded-md border border-slate-300 bg-white px-3 text-sm text-slate-900 focus:border-cyan-600 focus:outline-none" />
            <button type="button" className="rounded-md border border-cyan-700 bg-cyan-700 px-4 py-2 text-sm font-semibold text-white hover:bg-cyan-800">
              Filter
            </button>
          </div>
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <div className="flex gap-2">
              <button type="button" className="rounded-md border border-slate-300 p-2 text-slate-600 hover:bg-slate-50"><Columns3 className="h-4 w-4" /></button>
              <button type="button" className="rounded-md border border-slate-300 p-2 text-slate-600 hover:bg-slate-50"><Download className="h-4 w-4" /></button>
              <button type="button" className="rounded-md border border-slate-300 p-2 text-slate-600 hover:bg-slate-50"><Settings2 className="h-4 w-4" /></button>
            </div>
          </div>
        </div>
      </div>
...
export function FlottenmonitorPage() {
