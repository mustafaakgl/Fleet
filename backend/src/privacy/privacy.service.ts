...
export class PrivacyService {
  ...
  async streamDriverExport(driverId: string, actorUserId: string, res: Response): Promise<void> {
    ...
    archive.append(jsonLine({
      ...
      home_address_street: driver.homeAddressStreet,
      home_address_zip_code: driver.homeAddressZipCode,
      home_address_city: driver.homeAddressCity,
      home_address_country: driver.homeAddressCountry,
      notes: driver.notes,
