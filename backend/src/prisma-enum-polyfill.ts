...
const enumPolyfills: Record<string, EnumShape> = {
  ...
  DocumentOwnerType: asEnum(['driver', 'vehicle', 'company', 'request', 'transport_request', 'accident', 'cargo_damage', 'vehicle_handover', 'assignment', 'service_record', 'vehicle_equipment', 'equipment_issuance']),
  ...
  NotificationType: asEnum(['transport_request', 'request', 'document', 'handover', 'accident', 'cargo_damage', 'company_email', 'reminder', 'system', 'tacho_signature_invalid', 'tacho_infringement', 'tacho_download_due', 'device_silent', 'fuel_theft_suspected', 'telematics_coolant_high', 'telematics_voltage_low']),
