-- CreateEnum
CREATE TYPE "MessageTranslationStatus" AS ENUM ('not_requested', 'pending', 'translated', 'failed');
...
CREATE TABLE "Message" (
    ...
    "targetLanguage" TEXT,
    "translationStatus" "MessageTranslationStatus" NOT NULL DEFAULT 'not_requested',
...
-- CreateIndex
CREATE INDEX "Conversation_driverId_updatedAt_idx" ON "Conversation"("driverId", "updatedAt");
...
-- AddForeignKey
ALTER TABLE "Conversation" ADD CONSTRAINT "Conversation_driverId_fkey" FOREIGN KEY ("driverId") REFERENCES "Driver"("id") ON DELETE CASCADE ON UPDATE CASCADE;
