      ...
      <div className="fixed left-1/2 top-1/2 z-50 w-[min(1200px,96vw)] -translate-x-1/2 -translate-y-1/2 rounded-xl border border-slate-200 bg-white shadow-2xl">
        ...
        <div className="flex justify-end gap-2 border-t border-slate-200 px-5 py-4">
          ...
          <button
            ...
            className="rounded-md bg-brand-primary px-4 py-2 text-sm font-semibold text-white hover:bg-brand-primary disabled:cursor-not-allowed disabled:opacity-50"
          >
            Übernehmen
          </button>
        </div>
