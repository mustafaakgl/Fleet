...
export function MapPlaceholder() {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-surface shadow-2xl shadow-black/20">
      <div className="absolute inset-0 bg-gradient-to-br from-surface-border via-surface to-surface-card" />
      <div
        className="absolute inset-0 opacity-30"
        style={{
          backgroundImage:
            'linear-gradient(rgb(173 181 189 / 0.45) 1px, transparent 1px), linear-gradient(90deg, rgb(173 181 189 / 0.45) 1px, transparent 1px)',
      ...
      <div className="relative aspect-[16/10] p-6">
        ...
        {vehicles.map((vehicle) => (
          ...
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-brand-primary text-white shadow-lg ring-4 ring-white">
