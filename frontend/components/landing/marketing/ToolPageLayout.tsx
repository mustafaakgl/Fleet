    ...
    <>
      ...
      <div className="border-b border-slate-200 bg-slate-50">
        <div className="mx-auto flex max-w-7xl items-center px-6 py-3 lg:px-8">
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-sm font-semibold text-slate-600 transition hover:text-[#0066CC]"
          >
      ...
      {children}
      <section className="bg-[#002B5C] px-6 py-16 text-white lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <Link
              ...
              className="inline-flex items-center gap-2 rounded-full bg-[#0066CC] px-8 py-3.5 text-base font-bold text-white transition hover:bg-[#0052a3]"
            >
              {TRIAL_CTA_LABEL}
